...
class AddLetterToEditorModal extends Component
{
    public $title;
    ...
    public function mount()
    {
        ...
        $this->year = date('Y');
        $this->article_type_id = ArticleType::where('name', 'Letter to Editor')->first()->id;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.professors.add-letter-to-editor-modal', compact('articleTypes'));
    }
