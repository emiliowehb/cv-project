...
class AddNewsletterArticleModal extends Component
{
    public $title;
    ...
    public function mount()
    {
        ...
        $this->year = date('Y');
        $this->article_type_id = ArticleType::where('name', 'Newsletter')->first()->id;
    }
    ...
    public function render()
    {
        ...
        return view('livewire.professors.add-newsletter-article-modal', compact('articleTypes'));
    }
