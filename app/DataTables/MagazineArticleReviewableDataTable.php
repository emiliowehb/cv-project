...
class MagazineArticleReviewableDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('actions', function (Reviewable $reviewable) {
                return view('pages/apps.professor-submissions.magazine-articles.columns._actions', ['reviewable' => $reviewable]);
            })
            ->setRowId('id');
    }
    ...
    public function query(Reviewable $model): QueryBuilder
    {
        return $model->newQuery()
            ...
            ->where('professor_articles.article_type_id', 2)
    ...
    {
        return $this->builder()
            ->setTableId('magazine-article-reviewables-table')
            ...
            ->orderBy(0)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages/apps/professor-submissions/magazine-articles/columns/_draw-scripts.js')) . "}");
    }
    ...
    {
        return 'MagazineArticleReviewables_' . date('YmdHis');
    }
}
