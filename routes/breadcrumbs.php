...
// Home > Dashboard > Reports Generator
Breadcrumbs::for('dashboard.reports-generator', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(__('messages.reports_generator'), route('reports-generator.index'));
});
