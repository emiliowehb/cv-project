<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('dashboard.professors.my-profile', $professor) }}
    @endsection
    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                ...
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_user_view_overview_security">Education / Degrees</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_user_view_overview_events_and_logs_tab">Employment History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_user_view_overview_events_and_logs_tab">Publications</a>
                </li>
                <!--end:::Tab item-->
            </ul>
            <!--end:::Tabs-->
