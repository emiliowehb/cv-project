<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('dashboard.professors.my-profile.newsletter-articles', $professor) }}
    @endsection
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Modal-->
                        <livewire:professor.add-newsletter-article-modal></livewire:professor.add-newsletter-article-modal>
                        <!--end::Modal-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
    ...
    <script>
        document.addEventListener('livewire:init', function() {
            Livewire.on('success', function() {
                ...
                window.LaravelDataTables['professor-newsletter-articles-table'].ajax.reload();
            });
