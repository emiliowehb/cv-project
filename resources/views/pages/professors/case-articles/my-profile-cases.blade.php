<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('dashboard.professors.my-profile.cases', $professor) }}
    @endsection
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Modal-->
                        <livewire:professor.add-case-article-modal></livewire:professor.add-case-article-modal>
                        <!--end::Modal-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
    ...
    <script>
        document.addEventListener('livewire:init', function() {
            Livewire.on('success', function() {
                ...
                window.LaravelDataTables['professor-case-articles-table'].ajax.reload();
            });
