<div class="d-flex justify-content-end flex-shrink-0">
    <button type="button" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" wire:click="$emit('viewReviewableDetails', {{ $reviewable->id }})" data-reviewable-id="{{ $reviewable->id }}" data-kt-action="viewReviewableDetails">
        {!! getIcon('information', 'fs-2', '', 'i') !!}
    </button>
