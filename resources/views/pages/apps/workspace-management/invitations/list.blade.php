<x-default-admin-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('workspace-management.invitations.index') }}
    @endsection
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    <!--begin::Add user-->
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_member">
                        {!! getIcon('plus', 'fs-2', '', 'i') !!}
                        Invite new member
                    </button>
                    <!--end::Add user-->
                ...
                <!--begin::Modal-->
                <livewire:workspace.invite-member-modal></livewire:workspace.invite-member-modal>
                <!--end::Modal-->
            </div>
            <!--end::Card toolbar-->
        </div>
